...
def Other_data(more_data):
  ...
  return (Dates,all_countries,icu_patients,hosp_patients,cumulative_tests,new_tests,life_exp)
...
def padding_function(countries,all_countries,cases,deaths,cum_cases,cum_deaths,newtests,cumtests,hospat,icupat,L):
...
def World_data(Population_,Overall,Cumulative_cases_,Cumulative_deaths_,cumulative_tests_,New_cases_,New_deaths_,new_tests_,life_exp_):
    SumCases = 0
    SumDeaths = 0
    SumPop = 0
    SumTests = 0
    ...
    return (clist_total,dlist_total,tlist_total,clist_daily,dlist_daily,tlist_daily,day_list,time_list,SumCases,SumDeaths,W_c_p_m,W_d_p_m,SumTests,np.mean(life_expactancy),d_wor_pos_rate)
